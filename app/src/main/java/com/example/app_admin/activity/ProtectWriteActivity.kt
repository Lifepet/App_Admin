...
import kotlinx.android.synthetic.main.activity_protect_write.*
import kotlinx.android.synthetic.main.activity_protect_write.imageView4
...
class ProtectWriteActivity : AppCompatActivity() {
    private val PICK_FROM_ALBUM = 1
    var imageUrl: File? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_protect_write)
        ...
        bt_write.setOnClickListener { postWrite() }
    }
    ...
    fun postWrite() {
        ...
        val place = RequestBody.create(MediaType.parse("text/plane"), edit_place.text.toString())
        ...
        Connecter.api.postCare(getToken(applicationContext), title, sex, content, age, kind, place, fileName)
            .enqueue(object :
                Callback<Unit> {
